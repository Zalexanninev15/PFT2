...
## Description
Partitions Flashing Tool 2 - application for flash and dump partitions, disable Google FRP and remote by ADB for ZTE Blade V9 Vita, ZTE Blade A7 Vita and other smartphone on Qualcomm chipset (like as emmcdl tool) | [Commands in BAT files (PFT2_Flasher)](https://github.com/Zalexanninev15/PFT2/blob/master/About%20all%20commands.md)
