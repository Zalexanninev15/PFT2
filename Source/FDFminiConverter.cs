...
namespace PFT2
{
    public partial class FDFminiConverter : MaterialForm
    {
 
        public FDFminiConverter()
        {
            InitializeComponent();
        ...
        private void materialRaisedButton9_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("File \"FDFmini.exe\" not found!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
