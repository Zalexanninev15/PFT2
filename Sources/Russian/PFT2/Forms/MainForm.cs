...
#pragma warning restore CS0108
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Хотите перейти на страницу версии " + nver + "?", "Обнаружена новая версия!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        async void flasher()
        {
            if (File.Exists(emmcdl))
            {
                ...
                if ((materialSingleLineTextField4.Text != "") && (mbn != "") && ((materialRadioButton1.Checked == true) || (materialRadioButton2.Checked == true) || (materialRadioButton3.Checked == true) || (materialRadioButton4.Checked == true)))
                {
                    ...
                    catch { MessageBox.Show("COM порт не найден!", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error); }
                    if (c == 1)
                    {
                        try
                        {
                            if (materialRadioButton3.Checked == true) // Full Dump
                            {
                                ...
                                {
                                    MessageBox.Show("Отсутствует папка для полного бэкапа!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                }
                            }
                            if (materialRadioButton2.Checked == true) // Flash
                            {
                                ...
                                if (choose == 1)
                                {
                                    ...
                                    catch { MessageBox.Show("Невозможно взаимодействовать с устройством или с файлом для прошивки!", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error); }
                                }
                                MessageBox.Show("Выполнено!", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                ...
                else { MessageBox.Show("Что-то не заполнено!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); }
            }
            else { MessageBox.Show("emmcdl не найден!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); }
        }
        ...
        private void materialRaisedButton3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("COM порт не найден!", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                materialLabel7.Text = "НЕТ";
            }
        }
        ...
        private void materialRaisedButton2_Click(object sender, EventArgs e)
        {
            ...
            if (File.Exists(emmcdl))
            {
                if ((materialSingleLineTextField4.Text != "") && (code != ""))
                {
                    ...
                    process.Start();
                    process.WaitForExit();
                    materialLabel8.Text = "ДА";
                }
                else { MessageBox.Show("Что-то не заполнено!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); materialLabel8.Text = "НЕТ"; }
            }
            else { MessageBox.Show("emmcdl не найден!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); }
        }
        ...
        private void materialRaisedButton4_Click(object sender, EventArgs e)
        {
            ...
            else { MessageBox.Show("ADB не найден!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); materialLabel8.Text = "НЕТ"; }
        }
        ...
        {
            if (materialRadioButton1.Checked == true) { do_it.Text = "Сделать бэкап"; materialSingleLineTextField2.Enabled = true; materialRaisedButton8.Enabled = true; materialSingleLineTextField1.Enabled = true; folder_full_dump.Visible = false; materialRaisedButton7.Enabled = true; create_full_dump.Visible = false; do_it.Visible = true; }
        }

        private void materialRadioButton2_CheckedChanged(object sender, EventArgs e)
        {
            if (materialRadioButton2.Checked == true) { do_it.Text = "Прошить"; materialSingleLineTextField2.Enabled = true; materialRaisedButton8.Enabled = true; materialSingleLineTextField1.Enabled = true; folder_full_dump.Visible = false; materialRaisedButton7.Enabled = true; create_full_dump.Visible = false; do_it.Visible = true; }
        ...
        private void materialRaisedButton9_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Папка для полного бэкапа отсутствует!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        private void materialSingleLineTextField4_TextChanged(object sender, EventArgs e)
        {
            if (materialSingleLineTextField4.Text == "") { materialLabel7.Text = "НЕТ"; }
            if (materialSingleLineTextField4.Text != "") { materialLabel7.Text = "ДА"; materialLabel7.Text = "ДА"; }
        }
        ...
        {
            if (materialRadioButton4.Checked == true) { do_it.Text = "Отключить Google FRP"; materialSingleLineTextField2.Clear(); materialSingleLineTextField2.Enabled = false; materialRaisedButton8.Enabled = false; materialSingleLineTextField1.Clear(); materialSingleLineTextField1.Enabled = false; folder_full_dump.Visible = false; materialRaisedButton7.Enabled = false; create_full_dump.Visible = false; do_it.Visible = true; }
        }
        ...
        {
            openFileDialog1.FileName = "";
            openFileDialog1.Filter = "Файл MBN|*.mbn";
            if (openFileDialog1.ShowDialog() == DialogResult.Cancel) return;
        ...
        {
            openFileDialog1.FileName = "";
            openFileDialog1.Filter = "ADB файл|adb.exe";
            if (openFileDialog1.ShowDialog() == DialogResult.Cancel) return;
        ...
        private void materialRaisedButton5_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("Файл с приложениями отсутствует!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); }
        }
        ...
        private void materialRaisedButton7_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("Файл с разделами отсутствует!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); }
        }
        ...
        async void ADBCommander(string command)
        {
            ...
            if (File.Exists(adbp))
            {
                MessageBox.Show("Работа идет полным ходом...", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Process process1 = new Process();
                process1.StartInfo.FileName = "cmd.exe";
            ...
            else { MessageBox.Show("ADB не найден!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning); }
        }
    }
}
